...
import type { ButtonAction, ButtonColor, ButtonSize } from './Button';
import { baseButtonClasses, actionClasses, colorsClasses, sizeClasses } from './Button';

function getColorClass(action: ButtonAction | undefined, color: ButtonColor | undefined) {
...
function getSizeClass(size: ButtonSize | undefined) {
  return match(size)
