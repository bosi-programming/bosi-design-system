...
export function Linkedin({ className, size }: LinkedinProps) {
  const finalSize = size || '64px';
  return (
    <a aria-label="Linkedin" href="https://www.linkedin.com/in/felipebosi/" target="_blank" rel="noopener noreferrer">
      <svg
        className={className}
        height={finalSize}
        width={finalSize}
